<template>
  <div id="app">
    ...
    <van-tabbar v-model="active">
      <!-- to="/movie/main" -->
      <van-tabbar-item name="home" icon="home-o" @click="changeRouter"
        >电影</van-tabbar-item
      >
      <van-tabbar-item name="video-o" icon="video-o" to="/cinema"
        >影院</van-tabbar-item
      >
      <van-tabbar-item name="search" icon="search" to="/ask"
        >咨询</van-tabbar-item
      >
      <!-- 如果已登录 点击切换路由到/my -->
...
export default {
  ...
  methods: {
    changeRouter() {
      ...
      if (
        nowrouter === "/movie/round" ||
        nowrouter === "/movie/say" ||
        nowrouter === "/movie/people"
      ) {
